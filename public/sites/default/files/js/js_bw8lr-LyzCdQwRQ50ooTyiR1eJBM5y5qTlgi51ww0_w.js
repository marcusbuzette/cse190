...
(function ($, Drupal, window, document, undefined) {
  Drupal.theme.prototype.ucdedu_profile_highlight = function () {
    var html = '';
    ...
    html += '      <div class="modal-title">One of a Kind: ' + Drupal.CTools.Modal.currentSettings.title + '</div>';
    html += '    </div>';
    html += '    <div class="modal-scroll"><div id="modal-content" class="modal-content modal-content--ucdedu-profile-highlight"></div></div>';
    html += '  </div>';
    html += '</div>';
    return html;
  }
